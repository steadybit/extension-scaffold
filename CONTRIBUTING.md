...
To build and run this extension scaffold locally, you need:
...
| `$ make container` | Build the container image (`extension-scaffold:latest`) using Docker buildx.                          |
| `$ make eject`     | Replace the scaffold's README, LICENSE, CHANGELOG and CONTRIBUTING with the extension-author starting points (run this once after copying the scaffold). |
